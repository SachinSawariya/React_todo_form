...
function TodoItem({todo}) {
  ...
  return (
    <>
    <div className={`flex border border-black/10 rounded-lg px-3 py-1.5 gap-x-3 shadow-sm shadow-white/20
       duration-300 text-black
       ${todo.completed ? "bg-[#e2f1c3]" : "bg-[#ccbed7]"}`}>
        ...
        <button className='inline-flex w-8 h-8 rounded-lg text-sm border border-black/10
            justify-center items-center bg-gray-50 hover:bg-gray-200 shrink-0'
